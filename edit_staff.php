            ...
            <form action="admin/staff/update" method="POST">
                ...
                <div class="form-group mt-4">
                    ...
                    <input type="email" name="email" class="form-input" placeholder="Email Address"
                        value="<?= htmlspecialchars($staff['email']) ?>" required style="width: 100%;">
                </div>

                <div class="form-group mt-4">
                    <label>Description / Notes</label>
                    <textarea name="description" class="form-input" style="width: 100%; height: 120px;"
                        placeholder="Brief background or notes about the staff member..."><?= htmlspecialchars($staff['description'] ?? '') ?></textarea>
                </div>
